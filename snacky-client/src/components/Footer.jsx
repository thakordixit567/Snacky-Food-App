...
const Footer = () => {
  return (
    <div>
      <footer className="footer xl:px-24 py-10 px-4  bg-gradient-to-r from-slate-200 to-gray-200">
        <aside>
        ...
        <nav>
          <header className="footer-title text-semibold">Useful links</header>
